...
#import os
#os.chdir('/projects/modeslab/data_version_5/double_mutant/') #
...
#%%time
print("fold analysis at max bend energy")
...
df_allSims_at_maxBendEnegy.to_csv(path_to_dfs + "allSims_at_maxBendEnegy.csv",index = False)
...
print("Generated all dataframes. Happy plotting!")