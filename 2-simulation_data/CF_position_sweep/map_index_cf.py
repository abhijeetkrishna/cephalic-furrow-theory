...
def main():
    ...
    #'add_MD_bool':[0.0],
    'add_CF_bool':[1.0],
    'CF_position' : [0.17, 0.27, 0.37, 0.47, 0.6, 0.7, 0.8, 0.9], #5
    't_CF':[0.0],
    't_MD':[0.0, 5.0], 
    }
