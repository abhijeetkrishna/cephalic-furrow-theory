...
balls, springs = get_tissue(Nballs, K, L, K_md = K_md_by_K*K, R=R, R_vert_frac = R_vert_frac,  vitelline_shape = vitelline_shape, #close_loop=False, 
                                mitotic_domains_bool=mitotic_domains_bool, number_of_mitotic_domains = number_of_mitotic_domains,#mitotic_domains=mitotic_domains, 
                               #MD_growth_const_l0 = MD_growth_const_l0, 
                            #mitotic_growth = mitotic_growth, 
                            germ_band_push = germ_band_push,
                            #int_curvature_MD = int_curvature_MD,
                            #int_curvature_CF = int_curvature_CF,
                            #K_cf = K_cf
                            )
