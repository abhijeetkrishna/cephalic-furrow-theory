...
def main():
    job_id=sys.argv[1]
    var_dict={
    'K': [6e-5,7e-5,8e-5,9e-5,1e-4,1.1e-4, 1.2e-4, 1.3e-4, 1.4e-4], #np.geomspace(1,20,8)*1e-4,
    #'K': [8e-5,], #np.geomspace(1,20,8)*1e-4,
    #'int_curvature_CF': [0.3, 0.5,],
    #'R_vert_frac': [0.4],
    ...
    'germ_band_push' : [0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4], 
    'noise_scale' : [1e-5],
    'dt' : [1e-5],
