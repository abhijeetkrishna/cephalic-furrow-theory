...
function add_CF(balls; int_curvature_CF = 10.0, CF_position = 0.37, CF_width = 0.02)

    CF_id = balls[CF_position - CF_width/2 .< balls[:,"arclength_frac"] .< CF_position+CF_width/2, "ID"]
...
function energy_minimize(balls; #compulsory and optional arguments must be seperated by semi-colon
                    ...
                    CF_position = 0.37, CF_width = 0.02,
    ...
    while t<t_final
        ...
        if add_CF_bool && t>=t_CF
            ...
            balls = add_CF(balls, int_curvature_CF = int_curvature_CF, CF_position = CF_position, CF_width = CF_width)
...
CF_position = parse(Float64, sim_params[sim_params.variable .== "CF_position", :value][1])
CF_width = parse(Float64, sim_params[sim_params.variable .== "CF_width", :value][1])
...
balls_timeseries = energy_minimize(balls,springs = springs, seed = seed, 
                                               ...
                                               CF_position = CF_position, CF_width = CF_width,
